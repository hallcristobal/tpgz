...
namespace Timer { 
    ...
    void render(Font& font) {
        ...
        if (ToolItems[Tools::TIMER_INDEX].active) {
            ...
            font.renderChars(timer, 525.0f + (sprite_offsets[TIMER_INDEX].x), 420.0f + (sprite_offsets[TIMER_INDEX].y), 0XFFFFFFFF);
            font.renderChars(timerS, 525.0f + (sprite_offsets[TIMER_INDEX].x), 435.0f + (sprite_offsets[TIMER_INDEX].y), 0XFFFFFFFF);
		}
		...
		if (ToolItems[Tools::LOAD_TIMER_INDEX].active) {
            ...
            previous_frame = current_frame;
            font.renderChars(load_timerS, 525.0f + (sprite_offsets[LOAD_TIMER_INDEX].x), 30.0f + (sprite_offsets[LOAD_TIMER_INDEX].y), 0XFFFFFFFF);
		}
		...
		if (ToolItems[Tools::IGT_TIMER_INDEX].active) {
            ...
            previous_frame = current_frame;
            font.renderChars(igt_timer, 35.0f + (sprite_offsets[IGT_TIMER_INDEX].x), 30.0f + (sprite_offsets[IGT_TIMER_INDEX].y), 0XFFFFFFFF);
		}
